...
class DiffViewer extends React.Component {
    ...
    renderDiff = () => {
        ...
        const { lineInformation, diffLines } = computeLineInformation(oldValue, newValue, disableWordDiff, compareMethod, lineCompareMethod, linesOffset, this.props.alwaysShowLines);
