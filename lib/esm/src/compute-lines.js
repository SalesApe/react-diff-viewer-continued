 ...
 */
export const computeLineInformation = (oldString, newString, disableWordDiff = false, compareMethod = DiffMethod.CHARS, lineCompareMethod = undefined, linesOffset = 0, showLines = []) => {
    let diffArray = [];
