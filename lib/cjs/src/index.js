...
class DiffViewer extends React.Component {
    constructor(props) {
         ...
         */
        this.renderDiff = () => {
            const { oldValue, newValue, splitView, disableWordDiff, compareMethod, lineCompareMethod, linesOffset, } = this.props;
            const { lineInformation, diffLines } = (0, compute_lines_1.computeLineInformation)(oldValue, newValue, disableWordDiff, compareMethod, lineCompareMethod, linesOffset, this.props.alwaysShowLines);
